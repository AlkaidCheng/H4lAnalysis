...
void add_inputs_some_redu_bkg_no_bbh_tth_sum(int const number_of_bin = 1, float lower_cut = -1, float upper_cut = 1, TString cat = "0jet", TString systematic = "nominal"){
  ...
  TString redu_ttW = "outputs"+cat+"/output_category_"+cat+"_redu_ttW_"+systematic+".root";
  ...
  TFile *f_redu_ttW = new TFile(redu_ttW);
  ...
  TH1F *h_redu_ttW = (TH1F*)f_redu_ttW->Get("redu_ttW_BDT");
