...
/*  NEW IMPLEMENTATION  */
                   if(region[j]=="0jet") *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_pt_m\" High=\"0.9979\" Low=\"1.0021\" />" << std::endl;
                   if(region[j]=="1jet_lowpt4l") *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_pt_m\" High=\"1.0265\" Low=\"0.9735\" />" << std::endl;
                   if(region[j]=="1jet_mediumpt4l") *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_pt_m\" High=\"0.97\" Low=\"1.03\" />" << std::endl;
                   if(region[j]=="1jet_highpt4l") *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_pt_m\" High=\"1.1401\" Low=\"0.8599\" />" << std::endl;



                   if(region[j]=="2jet_VH_highpt4l") *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_pt_m\" High=\"1.1254\" Low=\"0.8746\" />" << std::endl;
                   if(region[j]=="2jet_VH_lowpt4l") *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_pt_m\" High=\"0.9971\" Low=\"1.0029\" />" << std::endl;

                   
                   if(region[j]=="2jet_VBF_lowpt4l") *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_pt_m\" High=\"0.9856\" Low=\"1.0144\" />" << std::endl;
                   if(region[j]=="2jet_VBF_highptjet") *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_pt_m\" High=\"1.1563\" Low=\"0.8437\" />" << std::endl;
...
//Katharina' implementation
                   if(region[j]=="1jet_lowpt4l")   *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_ptH_FxFx_m01\" High=\"1.176\" Low=\"0.85\" />" << std::endl;
                   if(region[j]=="1jet_mediumpt4l") *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_ptH_FxFx_m01\" High=\"0.78\" Low=\"1.178\" />" << std::endl; ;
                   if(region[j]=="1jet_highpt4l") *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_ptH_FxFx_m12\" High=\"0.773\" Low=\"1.188\" />" << std::endl; ;
//vbf for pt4l
////vbf for ptj
                  if(region[j]=="2jet_VBF_highptjet") *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_ptj1_FxFx_m01\" High=\"0.707\" Low=\"1.235\" />" << std::endl;
                   if(region[j]=="2jet_VBF_lowptjet") *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_ptj1_FxFx_m01\" High=\"1.27\" Low=\"0.775\" />" << std::endl ;

                   if(region[j]=="2jet_VH_lowpt4l") *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_ptH_FxFx_m01\" High=\"1.229\" Low=\"0.80\" />" << std::endl;
                   if(region[j]=="2jet_VH_highpt4l") *optfile <<"    <OverallSys Name=\"ATLAS_QCDscale_ggH_ptH_FxFx_m01\" High=\"0.591\" Low=\"1.266\" />" << std::endl;
