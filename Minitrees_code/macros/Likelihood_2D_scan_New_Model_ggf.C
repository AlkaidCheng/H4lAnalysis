...
void Likelihood_2D_scan_New_Model_ggf(TString wsInput = "output_combined_datastat_model.root" , TString workspace="combined" , TString model="ModelConfig" , TString dataName="obsData" /*"obsData" or "asimovData"*/, float coupling_1 = 1, float coupling_2 = 2 , TString formula_1 ="@1 + @0", TString file_readout = "function.txt", int number_of_base = 3, TString coupling_name_file = "coupling_name.txt", bool total_width_fix = true, bool ggf_BR_modification = true, const float inizio = -8, const float larghezza = 0.1, const int passi = 160 , bool total_mu_ggf = false, TString syst_names_file = "macros/systematics.txt" , bool fix_sm = true , const float starting_point_2 = -8, const float width_2 = 0.1, const int scan_point_2 = 6){
...
*/
    ...
    }//close the for over coupling so kagg
...
// bool total_width_fix = true, bool ggf_BR_modification = true
    ...
    file_name_string = "ggf_Khgg_2D_" + coupling_name[1] + "_only_";
