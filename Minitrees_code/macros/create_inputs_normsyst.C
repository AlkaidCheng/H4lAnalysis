...
//		if(w_syst == 0) std::cout << "w_syst = " << w_syst << std::endl;
            ...
            if ( (cat=="0jet")&&(prod_type==0) ) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1. /w_lumi));
            if ( (cat=="1jet")&&(prod_type==1) ) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1. /w_lumi ));
            if ( (cat=="2jet_VH")&&(prod_type==2) ) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1. /w_lumi ));
            if ( (cat=="2jet_VBF")&&(prod_type==3) ) histo_output->Fill(discriminant, weight_jet*w_syst*Luminosity_fb*(1. /w_lumi));
            if ( (cat=="VHlep")&&(prod_type==4) ) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1. /w_lumi ));
	    if ( (cat=="ttH")&&(prod_type==5) ) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1. /w_lumi ));

	    if ((cat=="2jet_merged")&&(prod_type==3 || prod_type==2)) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1. /w_lumi ));
...
*/	  
            if ( prod_type==1 ){
                if(cat=="1jet_highpt4l" && pt4l_fsr > 120.) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1. /w_lumi));
                if(cat=="1jet_lowpt4l" && pt4l_fsr <= 60.) histo_output->Fill( discriminant,weight_jet*w_syst*Luminosity_fb*(1./w_lumi));
                if(cat=="1jet_mediumpt4l" && pt4l_fsr >60 && pt4l_fsr <=120.) histo_output->Fill( discriminant,weight_jet*w_syst*Luminosity_fb*(1./w_lumi));

            }
            if ( prod_type==3 ){
                if(cat=="2jet_VBF_highpt4l" && pt4l_fsr > 120.) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1. /w_lumi));
                if(cat=="2jet_VBF_lowpt4l" && pt4l_fsr <= 120.) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1. /w_lumi));
            }
            if ( prod_type==2 ){
                if(cat=="2jet_VH_highpt4l" && pt4l_fsr > 120.) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1./w_lumi));
                if(cat=="2jet_VH_lowpt4l" && pt4l_fsr <= 120.) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1. /w_lumi));
            }
            if ( prod_type==3 ){
                if(cat=="2jet_VBF_highptjet" && leading_jet_pt > 200.) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1. /w_lumi));
                if(cat=="2jet_VBF_lowptjet" && leading_jet_pt <= 200.) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1. /w_lumi));
            }
            if ( prod_type==2 ){
                if(cat=="2jet_VH_highptjet" && leading_jet_pt > 150.) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1./w_lumi));
                if(cat=="2jet_VH_lowptjet" && leading_jet_pt <= 150.) histo_output->Fill( discriminant, weight_jet*w_syst*Luminosity_fb*(1./w_lumi));
            }
