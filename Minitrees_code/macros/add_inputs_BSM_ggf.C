...
void add_inputs_BSM_ggf(TString Histo_Output_Name="data_run_2_BDT", int const number_of_bin = 1, float lower_cut = -1, float upper_cut = 1, TString cat = "0jet", TString bsm = "ggH_SM"){
...
/*mc15_13TeV.341505.PowhegPythia8EvtGen_CT10_AZNLOCTEQ6L1_ggH125_ZZ4lep_noTau_nominal.root";*/
  TString s_vbf_bsm = "outputs/output_category_"+cat+"_vbfMG5_0p_nominal.root";
...
//  TString s_ttbar = "outputs/output_category_"+cat+"_ttbar_nominal.root";
  TString s_Redu_Bkg = "outputs/output_category_"+cat+"_Redu_Bkg_nominal.root";
  TString s_gg_ZZ_4l = "outputs/output_category_"+cat+"_gg_ZZ_bkg_4l_noTau_nominal.root";
  TString s_gg_ZZ_2mu2e = "outputs/output_category_"+cat+"_gg_ZZ_bkg_2e2mu_nominal.root";
