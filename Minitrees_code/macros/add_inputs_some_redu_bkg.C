...
void add_inputs_some_redu_bkg(TString HistoName = "null" ,int const number_of_bin = 1, float lower_cut = -1, float upper_cut = 1, TString cat = "0jet", TString systematic = "nominal"){
  ...
  TString redu_bbH_1 = "outputs/output_category_"+cat+"_redu_bbH_1_"+systematic+".root";
  TString redu_bbH_2 = "outputs/output_category_"+cat+"_redu_bbH_2_"+systematic+".root";
  TString redu_ttZ_1 = "outputs/output_category_"+cat+"_redu_ttZ_1_"+systematic+".root";
  TString redu_ttZ_2 = "outputs/output_category_"+cat+"_redu_ttZ_2_"+systematic+".root";
  TString redu_WWZ = "outputs/output_category_"+cat+"_redu_WWZ_"+systematic+".root";
  TString redu_WZZ = "outputs/output_category_"+cat+"_redu_WZZ_"+systematic+".root";
  TString redu_ZZZ_1 = "outputs/output_category_"+cat+"_redu_ZZZ_1_"+systematic+".root";
  TString redu_ZZZ_2 = "outputs/output_category_"+cat+"_redu_ZZZ_2_"+systematic+".root";
